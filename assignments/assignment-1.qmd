...
Now we will replace all NA values in the “polls_us_election_2016” data set as follows: For numeric columns, we will replace NA values with 2001. For character or factor columns,we will replace NA values with Barış.After that we willstore the modified data set as a new object.
